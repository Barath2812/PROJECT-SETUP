...
const StudentunitPage = () => {
  ...
  useEffect(() => {
    ...
    if (!storedCourseData) {
      navigate("./StudentCourseSelection"); // Redirect if no course data
      return;
    }
  ...
  return (
    <div className=" col-12 bg-light d-flex flex-column min-vh-100">
          ...
          <div className="container">
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav ms-auto">
                ...
                <li className="nav-item">
                  <a className="nav-link" href="https://project-setup-1.onrender.com/student-course-selection">Course</a>
                </li>
                <li className="nav-item">
      ...
      <div className="syllabus-container mt-3 mb-3 ">
